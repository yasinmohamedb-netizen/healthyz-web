// ===============================================
// GymProductsScreen.jsx (FINAL UPDATED + SEO)
// ===============================================
...
import GymSEO from "../../seo/GymSEO";  // ⭐ ADDED SEO

import "../Explore/ExploreScreen.css";

const db = getFirestore(firebaseApp);

export default function GymProductsScreen() {
  ...
  useEffect(() => {
    async function loadBanners() {
      ...
      try {
        const snap = await getDocs(collection(db, "promoBannerGym"));
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await axios.get(`${BASE_URL}/gym/products`);
        setProducts(Array.isArray(res.data) ? res.data : []);
      } catch (err) {
        console.error("Gym products error:", err);
      } finally {
        setLoading(false);
      }
    }
    ...
    <div className="explore-wrapper">
      ...
      <div className="explore-main">
        ...
        <header className="section-header">
          <h1 className="section-title">Explore Fitness Products</h1>
