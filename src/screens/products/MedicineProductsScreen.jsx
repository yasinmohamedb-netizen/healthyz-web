// ===============================================
// MedicineProductsScreen.jsx (FINAL UPDATED + SEO)
// ===============================================
...
import MedicineSEO from "../../seo/MedicineSEO";   // ⭐ ADDED

import "../Explore/ExploreScreen.css";

const db = getFirestore(firebaseApp);

export default function MedicineProductsScreen() {
  ...
  useEffect(() => {
    async function loadBanners() {
      ...
      try {
        const snap = await getDocs(collection(db, "promoBannerMedicines"));
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const res = await axios.get(`${BASE_URL}/medicines/products`);
        setProducts(Array.isArray(res.data) ? res.data : []);
      } catch (err) {
        console.error("Error fetching medicine products:", err);
      } finally {
        setLoading(false);
      }
    }
    ...
    <div className="explore-wrapper">
      ...
      <div className="explore-main">
        ...
        <header className="section-header">
          <h1 className="section-title">Explore Medicines</h1>
        ...
        {!loading && (
          <div className="product-grid">
            {filtered.map((item) => {
              ...
              const final = Math.round(base - (base * discountVal) / 100);
              ...
              return (
                ...
                >
                  <div className="prod-img-box">
                    ...
                    {discountVal > 0 && (
                      <span className="discount-tag">{discountVal}% OFF</span>
                    )}
                  </div>
                  ...
                  <div className="prod-info">
                    ...
                    <div className="price-row">
                      ...
                      {discountVal > 0 && (
                        <span className="cut-price">₹{base}</span>
                      )}
                    </div>
