// ===============================================
// SexualProductsScreen.jsx (FINAL UPDATED + SEO)
// ===============================================
...
// 🔥 ADD SEO
import SexualSEO from "../../seo/SexualSEO";

const db = getFirestore(firebaseApp);

export default function SexualProducts() {
  ...
  const [selectedCategory, setSelectedCategory] = useState("sexual");
  ...
  useEffect(() => {
    async function loadBanners() {
      ...
      try {
        const snap = await getDocs(collection(db, "promoBannerSexual"));
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const res = await axios.get(`${BASE_URL}/sexual/products`);
        setProducts(Array.isArray(res.data) ? res.data : []);
      } catch (err) {
        console.log("Error fetching sexual wellness products:", err);
      } finally {
        setLoading(false);
      }
    }
    ...
    <div className="explore-wrapper">
      ...
      <div className="explore-main">
        ...
        <header className="section-header">
          <h1 className="section-title">Explore Sexual Wellness</h1>
        ...
        <div className="search-section">
          <div className="search-bar">
            ...
            <input
              type="text"
              placeholder="Search Sexual Wellness Products..."
        ...
        {!loading && (
          <div className="product-grid">
            {filtered.map((item) => {
              ...
              const base = Number(String(item.price).replace(/[^0-9.]/g, ""));
              ...
              return (
                ...
                >
                  <div className="prod-img-box">
                    <img src={img} alt={item.name} className="prod-img" />
                  ...
                  <div className="prod-info">
                    ...
                    <div className="price-row">
                      ...
                      {d > 0 && <span className="cut-price">₹{base}</span>}
                    </div>
